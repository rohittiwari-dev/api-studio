				...
				<Container style={container}>
					...
					<Section style={content}>
						...
						<Section style={workspaceCard}>
							...
							<Text style={invitedBy}>
								Invited by {inviterName}
							</Text>
						</Section>

						<Text style={paragraph}>
							Join the workspace to start collaborating on API
							collections, environments, and more with your team.
						</Text>
						...
						<Text style={expireNote}>
							This invitation will expire in 7 days. If you
							weren&apos;t expecting this email, you can safely
							ignore it.
						</Text>
					</Section>
