				...
				<Container style={container}>
					...
					<Section style={content}>
						...
						<Text style={paragraph}>
							...
							{appName} account ({userEmail}) was successfully
							changed.
						</Text>

						{/* Activity Details */}
						<Section style={activityBox}>
							<Text style={activityTitle}>
						...
						<Section style={warningBox}>
							...
							<Text style={warningText}>
								If you didn&apos;t make this change, your
								account may be compromised. Please take
								immediate action:
							</Text>
						...
						<Text style={securityTip}>
							<strong>Security tip:</strong> Never share your
							password with anyone.
							{appName} will never ask for your password via
							email.
						</Text>
					</Section>
					...
					<Section style={footer}>
						<Text style={footerText}>
							...
							<Link
								href="https://apistudio.dev/support"
								style={link}
							>
								support team
							</Link>
