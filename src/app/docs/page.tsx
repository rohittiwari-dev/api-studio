						...
						<div className="min-w-0">
							...
							>
								...
								<p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
									Take full ownership of your data and
									infrastructure. Deploy Api Studio anywhere
									Docker or Node.js can run.
								</p>
							</motion.div>
							...
							<div className="space-y-32">
								...
								>
									...
									<p className="mb-6 text-muted-foreground">
										Define your core settings. Copy the
										example below into a
							...
							<div className="mt-32 p-12 rounded-[2.5rem] bg-secondary/30 border border-border relative overflow-hidden group">
								<div className="relative z-10">
									...
									<p className="text-muted-foreground mb-8 max-w-lg leading-relaxed">
										Join our community on Discord or follow
										updates on GitHub.
									</p>
