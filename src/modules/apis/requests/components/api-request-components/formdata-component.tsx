import { FileUp, FormInput, Plus, Trash2 } from "lucide-react";
                ...
                <div className="relative">
                  {param.type === "FILE" ? (
                    <div className="flex items-center gap-2">
                      <label
                        htmlFor="choose-file"
                        className="flex items-center gap-2 h-8 px-2.5 rounded-md text-xs border border-dashed border-indigo-500/30 hover:border-indigo-500/50 hover:bg-indigo-500/5 cursor-pointer transition-all flex-1"
                      >
