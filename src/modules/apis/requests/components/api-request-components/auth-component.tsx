				...
				return (
					<div className="flex flex-col items-center justify-center py-8 text-center">
						...
						<p className="text-xs text-muted-foreground mt-1 max-w-xs">
							This request will use the authentication configured
							in your workspace&apos;s global auth settings.
						</p>
						<div className="mt-4 px-3 py-2 rounded-lg bg-amber-500/5 border border-amber-500/20">
							<p className="text-[10px] text-amber-600 dark:text-amber-400">
								Configure global auth from the right sidebar →
								Global Auth
							</p>
						</div>
					</div>
				...
				{authType !== 'NONE' && authType !== 'INHERIT' && (
					<div className="px-4 py-3 border-t border-border/40 bg-muted/20">
						<p className="text-[10px] text-muted-foreground">
							...
							This authentication will override any
							workspace-level global auth settings.
						</p>
					</div>
				)}
			</div>
