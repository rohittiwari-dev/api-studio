...
export function TwoFactorSetup() {
	...
	const [step, setStep] = useState<'password' | 'setup' | 'verify'>(
		'password',
	);
					...
					<div className="pl-11">
						<div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
							...
							<div className="space-y-1">
								...
								<p className="text-xs text-muted-foreground">
									You signed in with a social account. To
									enable two-factor authentication, you need
					...
					<DialogFooter className="gap-2">
						...
						{step === 'password' && (
							<Button
								...
								disabled={
									!enablePassword || enableMutation.isPending
								}
							>
								{enableMutation.isPending && (
				...
				<DialogContent className="max-w-md">
					...
					<DialogFooter className="gap-2">
						...
						<Button
							...
							disabled={
								!disablePassword || disableMutation.isPending
							}
						>
			...
			>
				<DialogContent className="max-w-md">
					<DialogHeader>
						...
						<DialogDescription>
							New backup codes have been generated. Previous codes
							are now invalid.
						</DialogDescription>
					</DialogHeader>
