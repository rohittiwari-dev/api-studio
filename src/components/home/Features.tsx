		...
		>
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="text-center max-w-3xl mx-auto mb-20">
					...
					>
						A complete workspace designed for the modern API
						workflow. From request to response, every detail is
				...
				>
					...
					>
						...
						<div className="relative z-10">
							...
							<p className="text-muted-foreground mb-8 max-w-lg">
								Craft complex HTTP requests with ease. Support
								for all methods, custom headers, query
								parameters, and multiple body types including
								FormData and Binary.
							</p>
					...
					>
						...
						<div className="relative z-10 h-full flex flex-col">
							...
							<p className="text-muted-foreground mb-6 text-sm">
								Built-in support for OAuth 2.0, Bearer Tokens,
								Basic Auth, and more. Sensitive data is handled
								securely server-side.
							</p>
							<div className="mt-auto grid grid-cols-2 gap-2">
								{['OAuth 2.0', 'Bearer', 'Basic', 'Digest'].map(
									(type, idx) => (
										<motion.div
											key={type}
					...
					>
						...
						<div className="relative z-10">
							...
							<p className="text-muted-foreground mb-6 text-sm">
								Switch between Local, Staging, and Prop
								seamlessly using variables.
							</p>
						...
						<div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
							<div className="flex-1">
								...
								<p className="text-muted-foreground mb-6">
									Turn any request into code in your favorite
									language. Support for JavaScript, Python,
									Go, Swift, and 20+ more.
								</p>
