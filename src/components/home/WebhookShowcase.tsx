...
import { Radio, Globe, Activity, Server } from 'lucide-react';
				...
				<div className="grid lg:grid-cols-2 gap-16 items-center">
					...
					>
						...
						<p className="text-lg text-muted-foreground mb-8 leading-relaxed">
							Stop guessing what your webhooks are doing. Create
							unique endpoints instantly, inspect payloads in
							real-time, and mock responses to test your
