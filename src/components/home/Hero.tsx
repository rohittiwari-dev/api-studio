...
export default function Hero() {
  ...
  const [clientPulseLatencies, setClientPulseLatencies] = useState<number[]>([
    0, 0, 0,
  ]);
  ...
  useEffect(() => {
    // Generate random latencies only on the client to avoid SSR hydration mismatch
    setClientPulseLatencies(
      [1, 2, 3].map(() => Math.floor(Math.random() * 50 + 20)),
    );
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              Master your <br />
              <span className="bg-linear-to-r from-violet-600 via-indigo-600 to-purple-500 bg-clip-text text-transparent">
                API Workflow
              </span>
            </motion.h1>
          ...
          <div className="order-1 lg:order-2 perspective-[2000px] relative">
            <div className="absolute inset-0 bg-linear-to-tr from-violet-600/20 to-indigo-600/20 rounded-full blur-[100px] -z-10" />
              ...
              <div className="flex h-[400px] md:h-[480px]">
                ...
                <div className="w-16 md:w-56 border-r border-white/5 bg-[#0b0c10] flex flex-col pt-4">
                  ...
                  <div className="space-y-1 px-2">
                    ...
                    <div className="flex items-center gap-3 px-3 py-2 text-white/20 hover:bg-white/2 cursor-pointer">
                    ...
                    <motion.div
                      className={`w-40 border-r border-white/5 flex items-center px-4 gap-2 font-medium border-t-2 transition-all cursor-pointer ${
                        activeTab === 0
                          ...
                          : "border-t-transparent text-white/20 hover:bg-white/2"
                      }`}
