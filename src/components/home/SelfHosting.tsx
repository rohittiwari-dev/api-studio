						...
						<div className="relative z-10 flex flex-col lg:flex-row gap-12 items-start">
							...
							<div className="flex-1 lg:max-w-md">
								...
								<p className="text-lg text-muted-foreground leading-relaxed mb-8">
									Keep full control of your API testing
									environment. Deploy Api Studio on your own
									servers with just a few commands. No hidden
								...
								<div className="space-y-4">
									<AnimatePresence mode="wait">
										<motion.div
											...
											className="space-y-4"
										>
											{installationMethods[activeTab].map(
												(step, index) => (
													<motion.div
														key={step.num}
														initial={{
